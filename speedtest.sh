...
_constant() {
    ...
    node_set_2="https://ghp.ci/https://raw.githubusercontent.com/i-abc/speedtest/node/all-node-mirror.txt"
    ...
    speedtest_cli_tar_url_2="https://ghp.ci/https://raw.githubusercontent.com/i-abc/speedtest/asset/speedtest-cli/v${speedtest_cli_version}/ookla-speedtest-${speedtest_cli_version}-linux-${speedtest_cli_arch}.tgz"
